...
&&
&& Antes convert�a los seis caracteres que siguen a una barra y una u sin
&& mirar lo que eran, y strconv(...,16) se salta los que no son
&& hexadecimales y usa los que s�. Con eso, una RUTA de Windows se romp�a:
&&
...
&& ANTES de llegar aqu�, as� que lo que se ve es una barra literal, no un
&& escape. Y pasa tambi�n AL SERIALIZAR, porque Stringify vuelve a
&& tokenizar el JSON que acaba de montar.
&&
&& No se ve�a porque todo el c�digo de la casa vive en C:\Desarrollo\. Un
&& proyecto creado en el perfil del usuario nac�a con el manifiesto partido
&& y el JSON parec�a v�lido.
&&
&& Exigiendo cuatro hexadecimales, \Users y \Unidad dejan de ser escapes y
&& los \u00e1 leg�timos siguen funcionando igual.
&& --------------------------------------------------------------------
		...
		do while .t.
			...
			if len(lcHex) == 4 and this.IsHex4(lcHex)
				...
				&& Seguir DESPU�S de lo sustituido. El bucle viejo hac�a un
				&& strtran global y volv�a a empezar; con stuff hay que
...
&& IRODG 09/10/2023 Fin
	...
	&& Los cuatro caracteres de un \uXXXX. Sin esto, cualquier cosa detr�s de
